...
def test_correct_cron_hours_expression_for_utc():
    ...
    assert "23,1,8,11" == correct_cron_hours_expression_for_utc("1,3,10,13", summer.utcoffset())
    ...
    assert "0,2,9,12" == correct_cron_hours_expression_for_utc("1,3,10,13", winter.utcoffset())

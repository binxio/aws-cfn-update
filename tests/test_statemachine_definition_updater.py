...
def test_replace_body():
    ...
    definition = updater.template['Resources']['Machine1']['Properties'].get('DefinitionString')
    ...
    updater.update_template()
    assert updater.dirty
    definition = updater.template['Resources']['Machine2']['Properties'].get('DefinitionString')
